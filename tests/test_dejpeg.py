...
class TestTiledProcessing:
    ...
    def test_calculate_tiling_config(self):
        ...
        config = calculate_tiling_config(
...
class TestModelJxlOutput:
    ...
    @pytest.mark.parametrize(
        "model_string",
        [
            "waifu2x_cunet_art:noise0",
            "waifu2x_swin_unet_art:noise0",
            "waifu2x_swin_unet_art_scan:noise0",
        ],
    )
    ...
    @pytest.mark.parametrize(
        "model_string",
        [
            "waifu2x_swin_unet_art:noise0:scale2x",
        ],
    )

"""Comic metadata DTO for storing and transferring comic information."""
...
class ComicMetadata:
    """
    Data Transfer Object for comic metadata.

    Used to store and transfer comic information across the application,
    including metadata from:
    - Path-based extraction (bdlib.metadata.path)
    - Third-party providers (bdlib.metadata.comicvine, etc.)
    - CLI arguments
    """
    ...
    def merge(self, other: "ComicMetadata") -> "ComicMetadata":
        ...
        Fields from the other object will only be used if the corresponding
        field in this object is None (not set).
        """
